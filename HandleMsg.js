...
module.exports = HandleMsg = async (pakforlay, message) => {
	...
	// Filter Banned People
        ...
        case 'stikergif':
		    ...
		    pakforlay.reply(from, `[❗] Kirim gif/video max 10detik dengan caption *${prefix}stickergif*`, id)
	        }
            break
        case 'stikergiphy':
        case 'stickergiphy':
        ...
        case 'nulis':
            ...
            await pakforlay.sendImage(from, `${nulisp}`, '', 'Mager Amat Mau Nulis @rafnotme_', id)
            .catch(() => {
                pakforlay.reply(from, 'Ada yang Error!', id)
            })
            break
	...
	/*	case 'simisimi':
        ...
        case 'bc': //untuk broadcast atau promosi
            ...
            for (let idk of chatz) {
                ...
                if (!cvk.isReadOnly) pakforlay.sendText(idk, `〘 ZX BROADCAST 〙\n\n${msg}`)
                if (cvk.isReadOnly) pakforlay.sendText(idk, `〘 ZX BROADCAST 〙\n\n${msg}`)
            }
